...
export default function HomeStack() {
  ...
  return (
    <section className="relative w-full bg-[#050b16] py-48 px-6 md:px-24 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto grid md:grid-cols-2 gap-32 items-center">
        ...
        <div>
          ...
          <p className="text-lg text-cyan-100/70 max-w-xl">
            ...
            creating a unified control layer that drives faster, smarter,
            and more resilient decisions across your supply chain.
          </p>
        </div>

        {/* RIGHT — STACK + DATA STREAMS */}
            ...
            {[...Array(3)].map((_, i) => (
              ...
              >
                <div
                  ...
                  style={{
                    animation: `flow 2.${i}s linear infinite`,
                  }}
                />
              </div>
            ))}
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    transform: `
                      translateX(-50%)
                      translateY(${formed ? 0 : (i % 2 ? -140 : 140)}px)
                      translateX(${formed ? 0 : (i % 2 ? -160 : 160)}px)
                    `,
                    background:
                      "linear-gradient(135deg,#0bbcff,#005bff)",
                    boxShadow:
                      formed
                        ? "0 0 45px rgba(0,160,255,0.45)"
                        : "none",
                    opacity: formed ? 1 : 0,
                    transition:
